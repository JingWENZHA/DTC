...
class DTC:
    ...
    def __init__(self, n_clusters, input_dim, timesteps,
                 n_filters=50, kernel_size=10, strides=1, pool_size=3, n_units=[50, 1],
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_filters', default=20, type=int, help='number of filters in convolutional layer')
    ...
    parser.add_argument('--n_units', nargs=2, default=[100, 1], type=int, help='numbers of units in the BiLSTM layers')
